...
import "../Styling/podcastpage.css"
    ...
    const artists=[
      ...
      },
      {
        ...
        backgroundUrl: "https://assets.codepen.io/152347/mallrat.jpg"
          ...
          return (
            <div className='podcast_comtainer'>
                <NavBar/>
                <ul>
                ...
                <div className="section-content">
                  <div className="inner">
                    <div className="bio">
                      ...
                      <Button className='play_button' variant="secondary">Play</Button>
                    </div>
                  </div>
                </div>
              </li>
...
export default transition(PodcastPage);